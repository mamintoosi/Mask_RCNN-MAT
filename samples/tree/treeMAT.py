...
Modified by: M. Amintoosi, tree, num images per gpu:1
------------------------------------------------------------
...
#            height, width = image.shape[:2]
            ...
            self.add_image(
                "tree",
                image_id=im_file_name,  # use file name as a unique image id
                path=image_path,
                mask_path = mask_path)
...
#        # [height, width, instance_count]
        ...
        if len(bws.shape) == 3:
            nObj = bws.shape[-1]
        mask = np.zeros([height,width, nObj],
                    dtype=np.uint8)
